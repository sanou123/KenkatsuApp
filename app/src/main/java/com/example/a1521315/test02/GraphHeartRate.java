 ...
 * SelectSheetTable
 */
public class GraphHeartRate extends AppCompatActivity implements View.OnFocusChangeListener, SearchView.OnQueryTextListener {
    ...
    public boolean onQueryTextSubmit(String query) {
        ...
        if (c.moveToFirst()) {
            do {
                ...
                // 産地
                TextView textMadeIn = setTextItem(c.getString(8), GCH);     // TextViewのカスタマイズ処理
                // 個数
                TextView textNumber = setTextItem(c.getString(9), GE);      // TextViewのカスタマイズ処理
                // 単価
                TextView textPrice = setTextItem(c.getString(15), GE);      // TextViewのカスタマイズ処理
