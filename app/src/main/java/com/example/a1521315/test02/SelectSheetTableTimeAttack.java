...
public class SelectSheetTableTimeAttack extends AppCompatActivity {
    ...
    private void init() {
        ...
        //Cursor c = dbAdapter.search_time_attackDB(null, column , name_id);
        //Cursor c1 = dbAdapter.search_time_attackDB(null, column1,training_name);
