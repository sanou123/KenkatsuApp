...
public class TimeoutResult extends Activity {
    Globals globals;
    String coursename;
    String mileage;
    String maxheartbeat;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_timeout_result);
        ...
        btn_tweet.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplication(), TimeoutResultTweet.class);
                startActivity(i);
            }
        });
...
/////////////////////////////////////////////////////////////////////////
        ...
        dbAdapter.saveDB_DATA(name_id, globals.now_user, globals.year, globals.month,
                globals.day,globals.times_of_day, globals.maxheartbeat, globals.cal,
                globals.total_time, globals.total_mileage, globals.coursename, globals.time,
                globals.avg, globals.max, globals.mileage,globals.training_name,globals.graph_time);   // DBに登録
