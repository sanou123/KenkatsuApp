    ...
    public class EndlessRun extends Activity implements SurfaceHolder.Callback, Runnable, MediaPlayer.OnCompletionListener,View.OnClickListener {
        ...
        private static final String TAG = "EndlessRuner";
        ...
        Runnable myTimerTask = new com.example.a1521315.test02.EndlessRun.CntTimerTask();

        //シークバーに関する奴
        private ScheduledExecutorService seekbarscheduler;
        ScheduledFuture seekbarfuture;
        Runnable mySeekBarTask = new com.example.a1521315.test02.EndlessRun.SeekBarTask();
        ...
        public com.example.a1521315.test02.EndlessRun.WatchMeTask watchMeTask;
        ...
        /*心拍メーター*/
            ...
            //針をメーター0に戻す
            Thread SetBothNeedlesToZero = new  Thread(new com.example.a1521315.test02.EndlessRun.BothNeedlesToZero(zeroNeedle));
        ...
        public void onResume() {
            super.onResume();
            Log.d(TAG, "onResume");
            accessoryManager.enable(com.example.a1521315.test02.EndlessRun.this, getIntent());
        }
        ...
        public void PlayProcess(){
            ...
            Thread SetBothNeedlesToZero = new  Thread(new com.example.a1521315.test02.EndlessRun.BothNeedlesToZero(zeroNeedle));           //変えた菅原
            ...
            watchMeTask = new com.example.a1521315.test02.EndlessRun.WatchMeTask();//TimerTaskインスタンスを生成
        ...
        public void PauseProcess(){
            ...
            // ポップアップメニュー表示
            AlertDialog.Builder alertDialog = new AlertDialog.Builder(com.example.a1521315.test02.EndlessRun.this);
        ...
        public class SeekBarTask implements Runnable {
            public void run() {
                ...
                handler.post(new Runnable() {
                    @Override
                    public void run() {
                        Thread MoveGhost = new Thread(new com.example.a1521315.test02.EndlessRun.MoveGhostTask(PerSecond(10.4,356)));
                        MoveGhost.start();
                        Thread MoveMe = new Thread(new com.example.a1521315.test02.EndlessRun.MoveMeTask());
                        MoveMe.start();
                        Thread TestMileageTask = new Thread(new com.example.a1521315.test02.EndlessRun.MileageTask());
            ...
            if (event.getAction() == KeyEvent.ACTION_DOWN) {
                if (event.getKeyCode() == KeyEvent.KEYCODE_VOLUME_UP) {
                    if (mp != null) {
                        ...
                        Thread SetNeedleUp = new Thread(new com.example.a1521315.test02.EndlessRun.SpeedMeterNeedle(speedMeterAngle));
                        SetNeedleUp.start();
                        Thread SpeedUp = new Thread(new com.example.a1521315.test02.EndlessRun.SpeedMeterTask((float) speedCount));
                        SpeedUp.start();
                    }
                    return true;
                }
            ...
            if (event.getAction() == KeyEvent.ACTION_DOWN) {
                if (event.getKeyCode() == KeyEvent.KEYCODE_VOLUME_DOWN) {
                    if (mp != null) {
                        ...
                        Thread SetNeedleDown = new Thread(new com.example.a1521315.test02.EndlessRun.SpeedMeterNeedle(speedMeterAngle));
                        SetNeedleDown.start();
                        Thread SpeedDown = new Thread(new com.example.a1521315.test02.EndlessRun.SpeedMeterTask((float) speedCount));
                        SpeedDown.start();
                    }
                    return true;
                }
